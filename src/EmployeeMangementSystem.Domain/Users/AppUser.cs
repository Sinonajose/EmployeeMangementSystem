...
namespace EmployeeMangementSystem.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update EmployeeMangementSystemDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update EmployeeMangementSystemEfCoreEntityExtensionMappings to extend the IdentityUser entity
