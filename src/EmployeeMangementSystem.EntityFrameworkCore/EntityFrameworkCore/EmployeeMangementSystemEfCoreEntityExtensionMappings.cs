...
{
    public static class EmployeeMangementSystemEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE EmployeeMangementSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
